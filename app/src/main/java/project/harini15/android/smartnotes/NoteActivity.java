package project.harini15.android.smartnotes;
...
public class NoteActivity extends AppCompatActivity {
    ...
    private void actionDelete() {
        ...
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(this)
                ...
                .setMessage("Do you really want delete the note?")
                .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if(mLoadedNote != null && Utilities.deleteFile(getApplicationContext(), mFileName)) {
                            ...
                            Toast.makeText(NoteActivity.this, "Cant delete the note '" + mLoadedNote.getTitle() + "'"
                                    , Toast.LENGTH_SHORT).show();
                        }
                        finish();
                    }
